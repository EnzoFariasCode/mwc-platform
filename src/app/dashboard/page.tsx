...
// Componente do Modal (Passo 2)
import { NewProjectModal } from "@/components/dashboard/NewProjectModal";

export default function DashboardHome() {
  // Pegamos o tipo de usuário do contexto global
  const { userType, toggleUserType } = useDashboard();

  // Estado local apenas para abrir/fechar o modal
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <p className="text-slate-400 text-sm">Modo Profissional Ativo</p>
            </div>
          </div>
          {/* Botão de Ação Principal do Pro: Encontrar Projetos */}
        ...
        <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-2xl p-8 border border-white/5 relative overflow-hidden group">
          <div className="relative z-10 max-w-xl">
            ...
            <p className="text-slate-400 mb-6">
              Existem centenas de clientes publicando projetos agora. Envie uma
              proposta e feche negócio.
            </p>
            <Link href="/dashboard/encontrar-projetos">
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {/* Botão de Ação Principal do Cliente: Novo Projeto (Abre Modal) */}
        <button
      ...
      {/* Convite para assinar plano (Seja Pro) */}
      <div className="bg-gradient-to-br from-purple-900/40 to-slate-900 rounded-2xl p-8 border border-purple-500/20 relative overflow-hidden">
        <div className="relative z-10 flex flex-col items-start gap-4">
          ...
          <button
            onClick={toggleUserType} // Apenas troca a view para exemplificar
      ...
      {/* MODAL (Renderizado apenas quando estado é true) */}
      <NewProjectModal
        isOpen={isModalOpen}
