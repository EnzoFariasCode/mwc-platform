...
// Mock do Usuário e Profissional
const mockUser = {
  name: "daniel Sodré",
...
export default function CheckoutSaudePage({
  ...
  // Simula o processamento do pagamento e geração do Meet
        ...
        <div className="container mx-auto max-w-6xl px-4">
          ...
          <div className="mb-10">
            <Link
              ...
              className="inline-flex items-center gap-2 text-slate-400 hover:text-white transition-colors mb-6 text-sm cursor-pointer"
            >
                ...
                {step === 1 && (
                  <>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                      ...
                      <div className="flex items-center gap-3 bg-white/5 border border-white/5 p-4 rounded-xl">
                        ...
                        <div>
                          ...
                          <span className="text-sm font-semibold">
                            {mockUser.birthDate} - {mockUser.gender}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 justify-between pt-4 border-t border-white/10">
                      <button className="w-full sm:w-auto px-6 py-3 bg-white/5 hover:bg-white/10 border border-white/10 text-white text-sm font-semibold rounded-lg flex items-center justify-center gap-2 transition-all cursor-pointer">
            ...
            <div className="w-full lg:w-1/3">
              <div className="bg-gradient-to-b from-[#0f172a] to-[#020617] border border-white/10 rounded-2xl p-6 md:p-8 sticky top-32 shadow-2xl">
                ...
                <p className="text-center text-[10px] text-slate-500 mt-4 leading-relaxed">
                  ...
                  do Google Meet será gerado após o pagamento.
                </p>
              </div>
            </div>
          </div>
