...
import { X, Briefcase, CheckCircle2, Zap, Clock } from "lucide-react";
...
interface BecomeProfessionalModalProps {
  isOpen: boolean;
  onClose: () => void;
  // Agora onConfirm recebe os dados do profissional
        ...
        <div className="p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Complete seu perfil profissional para começar a receber propostas.
            </p>
          </div>
          ...
          <div className="bg-slate-900/30 p-3 rounded-xl border border-white/5 mb-6">
            <div className="flex items-center gap-2 text-xs text-slate-400 justify-center">
              <CheckCircle2 className="w-3 h-3 text-green-400" /> Perfil Público
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              disabled={isLoading}
              className="flex-1 py-3 px-4 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-xl transition-all disabled:opacity-50 text-sm"
            >
              Cancelar
            </button>
            <button
              ...
              disabled={isLoading}
              className="flex-1 py-3 px-4 bg-[#d73cbe] hover:bg-[#b0269a] text-white font-bold rounded-xl transition-all shadow-lg shadow-purple-900/20 disabled:opacity-70 flex items-center justify-center gap-2 text-sm"
            >
