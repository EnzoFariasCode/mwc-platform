"use client"; // Necessário para useState e useRef funcionarem

import { useState, useRef } from "react";
import Link from "next/link"; // Import do Next.js
  ...
  return (
    <section className="relative py-24 px-4 bg-slate-950 border-b border-white/5 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
        ...
        {/* Lado Esquerdo: Texto */}
        <div className="flex-1 flex flex-col gap-8 max-w-2xl text-center lg:text-left">
          <div className="border border-white/20 p-8 md:p-12 rounded-none bg-white/[0.02] backdrop-blur-sm relative group">
            ...
            <p className="text-slate-300 text-lg leading-relaxed mb-8 font-sans">
              Se você é um prestador de serviços e se vê capaz de atuar com diversas demandas, esse site é pra você.
              <br /><br />
              Veja nosso vídeo e entenda como você pode se tornar um profissional na MCW e começar hoje mesmo.
            </p>
        ...
        <div className="relative flex-shrink-0 w-[300px] h-[300px] md:w-[450px] md:h-[450px] flex items-center justify-center">
          
          {/* Borda Giratória (Conic Gradient) */}
          <div className="absolute inset-0 rounded-full animate-spin-slow"
               style={{
                 background: 'conic-gradient(#ff00ff, #6600ff, #0066ff, #00ccff, #ff00ff)',
                 filter: 'blur(10px)',
                 opacity: 0.8
               }} 
          />
          ...
          >
            <video
              ...
              // Ajuste o caminho do vídeo se for local, ex: src="/videos/meu-video.mp4" (salvo em public/)
