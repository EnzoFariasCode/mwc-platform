    ...
    <header className="fixed top-0 w-full z-50 border-b border-white/10 backdrop-blur-md bg-black/20 transition-all duration-300">
      <div className="container mx-auto px-4 h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex gap-8 text-sm font-medium text-slate-300">
          {/* Links de âncora continuam usando <a> ou Link com href="#..." */}
          <Link href="#como-funciona" className="hover:text-[#d73cbe] transition-colors cursor-pointer">
            Como funciona
          </Link>
          <Link href="#servicos" className="hover:text-[#d73cbe] transition-colors cursor-pointer">
            Serviços
          </Link>
          <Link href="#profissionais" className="hover:text-[#d73cbe] transition-colors cursor-pointer">
            Profissionais
          </Link>
        </nav>
