...
export type AdminAuditAction =
  ...
  | "PIX_WITHDRAWAL_RECEIPT_EMAIL_RETRIED"
  ...
  | "PROFESSIONAL_VERIFICATION_EMAIL_RETRY"
  | "CHAT_REPORT_REVIEW_STARTED"
  | "CHAT_REPORT_WARNING_ISSUED"
  | "CHAT_REPORT_CLOSED_WITHOUT_PENALTY"
  | "CHAT_REPORT_EMAIL_RETRY"
  | "EMAIL_OUTBOX_SMOKE_TEST_QUEUED"
  | "EMAIL_OUTBOX_MANUALLY_PROCESSED"
  | "EMAIL_OUTBOX_RETRY_QUEUED";
